...
@Configuration
@ComponentScan(basePackages = {"org.usco.lcms.dao", "org.usco.lcms.service", "org.usco.lcms.scheduling"})
//@PropertySource(value = { "file:/etc/migrador/application.properties" })
@PropertySource(value = { "file:\\C:\\var\\migrador\\application.properties" })
@EnableScheduling
